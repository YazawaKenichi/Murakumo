...
F 0 "#PWR0124" H 2600 3100 50  0001 C CNN
...
F 0 "R44" H 2670 3546 50  0000 L CNN
F 1 "10k" H 2670 3455 50  0000 L CNN
...
F 0 "SW6" V 2554 4198 50  0000 L CNN
F 1 "SW1" V 2645 4198 50  0000 L CNN
...
F 0 "C37" H 2365 4096 50  0000 L CNN
F 1 "0.1u" H 2365 4005 50  0000 L CNN
...
F 0 "#PWR0136" H 2600 4200 50  0001 C CNN
...
F 0 "#PWR0122" H 1100 3100 50  0001 C CNN
...
F 0 "R42" H 1170 3546 50  0000 L CNN
...
F 0 "SW4" V 1054 4198 50  0000 L CNN
F 1 "SW3" V 1145 4198 50  0000 L CNN
F 2 "" H 1100 4250 50  0001 C CNN
F 3 "http://www.apem.com/int/index.php?controller=attachment&id_attachment=488" H 1100 4250 50  0001 C CNN
	1    1100 4050
	0    1    1    0   
$EndComp
$Comp
...
F 0 "C35" H 865 4096 50  0000 L CNN
F 1 "C" H 865 4005 50  0000 L CNN
F 2 "" H 788 3900 50  0001 C CNN
...
F 0 "#PWR0134" H 1100 4200 50  0001 C CNN
...
50uA
Text Notes 2500 3600 1    50   ~ 0
330uA\n
Text Notes 8550 2200 0    50   ~ 0
1.32mA\n
Text Notes 1450 2950 0    200  ~ 0
Switch
...
F 0 "#PWR0123" H 1850 3100 50  0001 C CNN
...
F 0 "R43" H 1920 3546 50  0000 L CNN
...
F 0 "SW5" V 1804 4198 50  0000 L CNN
F 1 "SW2" V 1895 4198 50  0000 L CNN
F 2 "" H 1850 4250 50  0001 C CNN
F 3 "http://www.apem.com/int/index.php?controller=attachment&id_attachment=488" H 1850 4250 50  0001 C CNN
	1    1850 4050
	0    1    1    0   
$EndComp
$Comp
...
F 0 "C36" H 1615 4096 50  0000 L CNN
F 1 "0.1u" H 1615 4005 50  0000 L CNN
...
F 0 "#PWR0135" H 1850 4200 50  0001 C CNN
...
Text Notes 1750 3600 1    50   ~ 0
330uA\n
Text Notes 1000 3600 1    50   ~ 0
330uA\n
Wire Wire Line
	1100 3750 1350 3750
Wire Wire Line
...
Wire Wire Line
	5200 7450 5200 7200
Text Label 2850 3100 3    50   ~ 0
SW1
Text Label 2100 3100 3    50   ~ 0
SW2
Text Label 1350 3100 3    50   ~ 0
SW3
Wire Wire Line
	2050 1550 2050 1750
...
U 1 1 61F6ED9A
P 3250 4000
F 0 "J14" H 3250 3200 50  0000 C CNN
F 1 "CPU_GPIOandTIMER" V 3350 3850 50  0000 C CNN
